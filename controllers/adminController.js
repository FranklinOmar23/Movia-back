...
exports.getUserWatchlist = async (req, res) => {
  try {
    ...
    res.status(500).json({ error: 'Error al obtener watchlist del usuario' });
  }
};
...
exports.getUserWatchHistory = async (req, res) => {
  try {
    ...
    console.error('❌ Error en getUserWatchHistory:', error);
    res.status(500).json({ error: 'Error al obtener historial de reproducción del usuario' });
  }
};
